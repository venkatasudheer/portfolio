...
// EXP
var exps = '2018-11-18';
var expss = new Date(exps);
var today = new Date();
var exp = Math.floor((today-expss) / (365.25 * 24 * 60 * 60 * 1000));
$('#exp').data('to',exp);
/*------------------------------------
    Counter
-------------------------------------- */
...
form.on('submit', function (e) {
	e.preventDefault(); // prevent default form submit
				...
				var email = $('#email').val();
				var msg = $('#msg').val();
				var url = "https://wa.me/918688088368?text=Name: "+ name + "%0D%0AEmail: "+ email + "  %0D%0A Message="+ msg + ".";
