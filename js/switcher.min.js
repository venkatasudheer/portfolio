! function(t) {
    ...
    t(".switcher-toggle").on("click", function() {
        ...
        "-202px" === e.css("right") ? t(e).animate({
            ...
            right: "-202px"
        }, 300).removeClass("shadow"), "-202px" === s.css("left") ? t(s).animate({
            left: "0px"
        ...
        t("#color-switcher").attr("href", s), t(this).parent().find("li").removeClass("active"), t(this).addClass("active")
    }), t("#reset-color").on("click", function() {
        t("#color-switcher").removeAttr("href"), t("#styles-switcher ul li").parent().find("li").removeClass("active")
    })
}(jQuery);